...
// let players: info.PlayerInfo[]; // <-- I don't think I use this
 ...
 export enum WinTypes {
    ...
    */
    ...
    //% inlineInputMode=inline
    //% help=github:docs/start_countdown_game
    ...
    //% winEffect.defl=effects.confetti
    //% inlineInputMode=inline
    //% help=github:docs/on_game_over_expanded
    ...
    //% inlineInputMode=inline
    //% help=github:docs/on_game_over_custom_expanded
   ...
   */
    ...
    //% kind.shadow=spritekind
    //% inlineInputMode=inline
    //% help=github:docs/create_projectile_ball
    ...
    //% inlineInputMode=inline
    //% expandableArgumentMode=toggle
    //% help=github:docs/spritescreateprojectileball
...
class Ball extends sprites.ExtendableSprite {
    ...
    //% this.defl=myBall
    //% help=github:docs/set_trace_multi
    ...
    //% len.defl=50
    //% this.defl=myBall
    //% help=github:docs/set_trace_iter
    ...
    //% on.shadow=toggleOnOff
    //% inlineInputMode=inline
    //% help=github:docs/control_ball_keys
  ...
  */
    ...
    //% this.defl=myBall
    //% inlineInputMode=inline
    //% help=github:docs/variable_power
